...
labeled **ShokoMetadata.bundle**. Move this folder into the following directory:

```cmd
%LOCALAPPDATA%\Plex Media Server\Plug-ins
````

Now you need to move the **Movie** and **Series** scanners into the scanner folder. If you never installed custom
scanners before, you might need to create the folder labeled **Scanners** manually. The **Movie** and **Series**
scanners are located in the following directory:
...
order for them to properly work with Shoko.
...
Open **Shoko Series Scanner.py** and make adjustments to the **Prefs** section to align it with your Shoko
configuration. For the majority of users, you'll simply need to update the **username** and **password** fields.
