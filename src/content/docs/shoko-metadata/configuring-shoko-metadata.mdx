...
After following the instructions above and  If you are a Plex Pass user, you can use Webhooks to automatically forward scrobble events to Shoko Server.
This way you don't need to run the "Sync Plex Watch Status" action manually.
