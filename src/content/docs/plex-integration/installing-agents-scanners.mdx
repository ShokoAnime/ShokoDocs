...
1. Download and Extract the Plugin
    - Download the [Shoko Relay](https://shokoanime.com/downloads/) plugin.
...
3. Install the Series Scanner
    ...
    - Navigate to the following directory:
      ...
      ```
    - Move the `Series` scanner folder into the following directory:
      ```cmd
...
Before you continue forward, make sure you have Shoko Server installed and running and have downloaded the
[Shoko Relay](https://shokoanime.com/downloads/) agents and scanners.
