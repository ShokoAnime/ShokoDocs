...
Neither plugin is not a standalone plugin and **requires Shoko Server** installed, configured and running.
...
Once down, move the folder into the following directory.
