...
### Shoko Metadata
Before you continue, make sure you have Shoko Server installed and running and have downloaded the
...
Before you continue, make sure you have Shoko Server installed and running.
...
<EasyTable
  ...
  data={[
    ...
    [
      ...
      "Episodes are no longer separated by seasons when matched with TMDB. All normal episodes are put into Season 1, and specials into Season 0"
    ],
  ]}
