...
**ShokoRelay.bundle** as the contents. If there is **anything** after the **.bundle** part, make sure to rename it.
...
Edit the `Prefs` section **in each scanner** using your preferred cmd editor so they match with your **Shoko Server** install.
