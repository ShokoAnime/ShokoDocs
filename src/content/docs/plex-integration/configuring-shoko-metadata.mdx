...
When prompted to select the Media Folder, and browse to your anime collection. Even though Shoko will provide the
...
movie library, choose: Scanner **Shoko Movie Scanner** and Agent **ShokoMovies**.
