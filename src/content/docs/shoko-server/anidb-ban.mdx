...
AniDB provides access to two different APIs, an HTTP API and an UDP API.
...
Shoko enforces these rate limits as seen in the code snippets below.
...
As of **January 10th, 2024**, there are **14,554 entries** in the XML Cache.

[Click Here](https://shokoanime.com/files/shoko-server/other/Anime_HTTP.zip) to download the XML Cache and follow the
instructions below to utilize it.
...
<EasyTable
  ...
  data={[
    ...
    ["Linux/macOS", "~/.shoko/Shoko.CLI/Anime_HTTP"],
  ]}
