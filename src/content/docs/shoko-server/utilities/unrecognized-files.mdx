...
![Shoko Server - Unrecognized Files - Unrecognized Section](/src/assets/img/shoko-server/shoko-server-unrecognized-files-unrecognized.jpg)
...
![Shoko Server - Unrecognized Files - AvDump](/src/assets/img/shoko-server/shoko-server-unrecognized-files-avdump.jpg)
...
refer to the [AniDB](http://localhost:4321/shoko-server/settings/#anidb) section on the **Settings** page.
...
![Shoko Server - Unrecognized Files - Manual Link](/src/assets/img/shoko-server/shoko-server-unrecognized-files-manual-link-01.jpg)
...
![Shoko Server - Unrecognized Files - Ignored](/src/assets/img/shoko-server/shoko-server-unrecognized-files-ignored.jpg)
...
![Shoko Server - Unrecognized Files - Ignored Listing](/src/assets/img/shoko-server/shoko-server-unrecognized-files-ignored-listing.jpg)
