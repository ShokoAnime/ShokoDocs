...
For those interested in creating a unique interface, the [Web UI Theme](/shoko-server/themes) section provides
...
![Shoko Server - Settings - Collection](../../../assets/img/shoko-server/shoko-server-settings-collection.jpg)
