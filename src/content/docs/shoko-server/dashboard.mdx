...
![Shoko Server - Dashboard - Display Settings](../../../assets/img/shoko-server/shoko-server-dashboard-display.jpg)
...
<EasyTable
 ...
 data={[
  ...
  [
   ...
   'This setting lets you define how many episodes are displayed in the Recently Imported widget. There is a maximum limit of 100 episodes, and if you set it to anything higher, it will default to 100.',
  ],
  [
   'Recently Imported Series',
   'This setting lets you define how many series are displayed in the Recently Imported widget. There is a maximum limit of 100 episodes, and if you set it to anything higher, it will default to 100.',
  ],
 ]}
 center={true}
...
<EasyTable
 header={['Job Name', 'Default', 'Description']}
 data={[
  [
   'HashFileJob',
   '1',
   'Determines how many workers are allocated to hashing files',
  ],
  [
   'UpdateTmdbShowJob',
   '1',
   'Determines how many workers are allocated to running TMDB series tasks.',
  ],
  [
   'UpdateTmdbMovieJob',
   '1',
   'Determines how many workers are allocated to running TMDB movie tasks.',
  ],
 ]}
 center={true}
 columnWidths={{ 'Job Name': '25%', 'Default': '15%', Description: '60%'}}
/>
...
![Shoko Server - Dashboard - Next Up](../../../assets/img/shoko-server/shoko-server-dashboard-next.jpg)
...
![Shoko Server - Dashboard - Upcoming Anime](../../../assets/img/shoko-server/shoko-server-dashboard-upcoming.jpg)
...
![Shoko Server - Dashboard - Recommended Anime](../../../assets/img/shoko-server/shoko-server-dashboard-recommended.jpg)
