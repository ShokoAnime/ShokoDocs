...
![Shoko Server - First Run - Welcome](../../../assets/img/shoko-server/shoko-server-first-run-welcome.jpg)
...
![Shoko Server - First Run - Local Account](../../../assets/img/shoko-server/shoko-server-first-run-local-account.jpg)
...
![Shoko Server - First Run - AniDB Account](../../../assets/img/shoko-server/shoko-server-first-run-anidb-account.jpg)
...
![Shoko Server - First Run - Start Server](../../../assets/img/shoko-server/shoko-server-first-run-metadata-sites.jpg)
...
![Shoko Server - First Run - Start Server](../../../assets/img/shoko-server/shoko-server-first-run-starting-server.jpg)
...
![Shoko Server - First Run - Start Server](../../../assets/img/shoko-server/shoko-server-first-run-import-folders.jpg)

Import folders are the physical locations for where your files are stored, critical for Shoko's functionality. These
locations need to be consistently accessible to Shoko and remain online, ensuring Shoko does not mistakenly remove
files from your collection. While you can use removable or cloud-based media, Shoko is not optimized for these
storage types. Operations such as automatic imports or file checks might inadvertently remove items from your
collection due to the nature of these storage solutions.

When setting up an import folder, you have two options. The first, **Watch For New Files**, instructs Shoko to monitor
the folder for any new files or changes, automatically importing any new files detected. The second option involves
using **Drop Folders** as a means to move files from a **Drop Source** to a **Drop Destination**, facilitating file
management and organization.

To create a new import folder, select **Add Import Folder**. Next, enter your preferred name for the import folder and
specify its location by selecting from available options or entering it manually. Select the **Import Folder Type** that
best suits your needs for this folder. Once completed, click the **Save** button to finalize its addition. Should you
need to include additional folders, ensure this is done before moving on to the next steps.
...
![Shoko Server - First Run - Start Server](../../../assets/img/shoko-server/shoko-server-first-run-data-collection.jpg)
...
![Shoko Server - Dashboard](../../../assets/img/shoko-server/shoko-server-dashboard.jpg)

This guide covers the basic requirements for setting up Shoko Server. If you want to customize your experience further,
check out the [Settings](#) under Shoko Server. These settings let you personalize Shoko to suit your preferences and
