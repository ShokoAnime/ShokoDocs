...
run the installer and follow the instructions listed, it should only take a couple of minutes to install Shoko.
...
**[Synology Container File](/files/synology-dockerfile.json)**. Replace the ``/path/to/anime``, `PUID`
