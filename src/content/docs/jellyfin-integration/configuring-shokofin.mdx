...
:::caution[Attention Windows Users]
  ...
  to use it is detailed in our
  [Recommendations and Limitations](/jellyfin-integration/recommendations-and-limitations/#TODO) section. Or you can
  jump straight to [Microsoft's guide]() to enable developer mode which will allow Shokofin to create symbolic links on 
  Windows and allows the VFS to function. Restarting Jellyfin is required once developer mode has been enabled.
:::
...
:::note[Advanced Options]
  ...
  by clicking the Shoko Server version number under the Connection Settings section 7 times. Advanced options will be
