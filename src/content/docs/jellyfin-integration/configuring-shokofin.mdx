...
:::caution[Notice]
  ...
  feature and is normally enabled by default. More info on what the VFS is, how to make sure it works on Windows, and
  what it means for you if you choose not to use it is detailed in our
  [Recommendations and Limitations](/jellyfin-integration/recommendations-and-limitations/#TODO) section.
:::
