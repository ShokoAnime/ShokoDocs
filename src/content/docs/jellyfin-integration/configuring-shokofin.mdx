...
read through the [Shokofin FAQs](#) or the [Recommendations and Limitations]() of Shokofin for any other expectations
and useful knowledge when it comes to the plugin.