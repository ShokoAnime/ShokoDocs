...
or inneficient behavior when changing any of these settings. Be sure to read what each option does before changing so
you have an idea what's relavent to you as well as what to expect.
