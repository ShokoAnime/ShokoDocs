---
title: Installing & Configuring Shokofin
description: Information on how to install and configure Shokofin.
sidebar:
  badge:
    text: New
    variant: tip
...
5. Click on "Catalog" on the top of the Plugins page.
6. Scroll down and till you find "Shokofin" under the Metadata section, and click it.
7. Click the blue **Install**-button. You will get a pop up warning you about using untrusted plugins. Click Ok.
8. Restart your server to apply the changes.
...
![Shokofin - Connection Settings](./src/assets/shokofin/Shokofin-Connection-Settings.png)
...
The Configuration page is still a WIP. In the meantime until it goes live then I will suggest asking in our discord server if you need help configuring the plugin.
