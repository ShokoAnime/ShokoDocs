...
<Accordion>
  <AccordionItem title='System Requirements?'>
    ...
    **Collection Size**
    ...
    the
    more resources Shoko will need to use. Users attempting to run Shoko on devices such as Raspberry Pi's and similar
    ...
    **Memory (RAM):**
    ...
    may
    experience slowdowns and delays in processes.

    **Hashing Process:**

    Hashing is a resource-intensive operation that involves significant CPU and I/O usage, as the entire file needs to
    be
    read and processed. If time is not a critical factor and you are willing to trade off processing speed, the hashing
