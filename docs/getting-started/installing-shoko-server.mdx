...
**Note:** As the management using **Container Station** will feel a bit clunky, we recommend starting the container using the instructions given under [Docker command-line](#docker-commandline) above.
...
Docker is not natively supported on this platform, as **TrueNAS Core** detrives from FreeBSD.
