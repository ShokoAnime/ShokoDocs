...
<EasyTable
  ...
  data={[
      ...
      [
          ...
          '**Note #1:** The first path in the mapping (**/path/to/anime**) is the location on your host computer, the second path (**/mnt/anime**) in the mapping is where you want to mount it inside the container.<br />' +
